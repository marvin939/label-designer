...
#
# Created: Thu Feb 14 17:31:14 2013
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.alignTop = QtGui.QPushButton(self.groupBox_2)
        self.alignTop.setGeometry(QtCore.QRect(70, 20, 101, 23))
        self.alignTop.setObjectName(_fromUtf8("alignTop"))
        self.alignLeft = QtGui.QPushButton(self.groupBox_2)
        self.alignLeft.setGeometry(QtCore.QRect(10, 40, 101, 23))
        self.alignLeft.setObjectName(_fromUtf8("alignLeft"))
        self.alignRight = QtGui.QPushButton(self.groupBox_2)
        self.alignRight.setGeometry(QtCore.QRect(130, 40, 101, 23))
        self.alignRight.setObjectName(_fromUtf8("alignRight"))
        self.alignBottom = QtGui.QPushButton(self.groupBox_2)
        self.alignBottom.setGeometry(QtCore.QRect(60, 60, 121, 23))
        self.alignBottom.setObjectName(_fromUtf8("alignBottom"))
        ...
        self.useSubset = QtGui.QCheckBox(self.layoutWidget)
        ...
        self.subsetBottom = QtGui.QSpinBox(self.layoutWidget)
        ...
        self.subsetTop = QtGui.QSpinBox(self.layoutWidget)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout.addWidget(self.loadData, 6, 0, 1, 1)
        self.createPdfBtn = QtGui.QPushButton(self.layoutWidget)
        ...
        self.printerList = QtGui.QComboBox(self.layoutWidget)
        ...
        self.dataInfo = QtGui.QLabel(self.layoutWidget)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.dataInfo.sizePolicy().hasHeightForWidth())
        self.dataInfo.setSizePolicy(sizePolicy)
        self.dataInfo.setText(_fromUtf8(""))
        self.dataInfo.setObjectName(_fromUtf8("dataInfo"))
        self.gridLayout.addWidget(self.dataInfo, 5, 0, 1, 1)
        ...
        self.permitPosition = QtGui.QComboBox(self.layoutWidget)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 292, 379))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.alignRight.setText(QtGui.QApplication.translate("MainWindow", "Align Right Edges", None, QtGui.QApplication.UnicodeUTF8))
        self.alignBottom.setText(QtGui.QApplication.translate("MainWindow", "Align Bottom Edges", None, QtGui.QApplication.UnicodeUTF8))
        self.label.setText(QtGui.QApplication.translate("MainWindow", "Zoom:", None, QtGui.QApplication.UnicodeUTF8))
        self.useSubset.setText(QtGui.QApplication.translate("MainWindow", "Use Subset?", None, QtGui.QApplication.UnicodeUTF8))
